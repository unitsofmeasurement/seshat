...
abstract class AbstractConverter implements UnitConverter, Serializable {
    ...
    /**
     * Delegates to {@link #derivative(double)} if the given converter is a Seshat implementation,
    ...
    static double doubleValue(final Number n) {
        return (n instanceof Float) ? MathFunctions.floatToDouble(n.floatValue()) : n.doubleValue();
    }
