...
final class Prefixes {
     ...
     * that Seshat uses in unit symbols) and the U+03BC character for the Greek small letter “mu” (the latter is the
    ...
    static char symbol(double scale, final int power) {
        ...
        final int n = MathFunctions.toExp10(Math.getExponent(scale)) + 1;
