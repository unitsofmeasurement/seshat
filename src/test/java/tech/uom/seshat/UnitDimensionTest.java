...
public final strictfp class UnitDimensionTest {
    ...
    public void testMultiply() {
        ...
        assertEquals(expected, LENGTH.multiply(TIME).getBaseDimensions());
    }
    ...
    public void testRationalPower() {
        ...
        assertEquals(expected, ((UnitDimension) dim).components);
        try {
    ...
    public void testGetBaseDimensions() {
        ...
        assertEquals(expected, FORCE.getBaseDimensions());
    }
